...
create table teaches_elective(
	code varchar(10),
	name varchar(30),
	teacher varchar(25),
	coteacher varchar(25),
	room varchar(10),
	timeslot1 varchar(15),
	timeslot2 varchar(15),
	day varchar(10),
	pool integer);
...
create table teachessection(
	...
	code varchar(10),
	initials varchar(10),
	foreign key(initials) references faculty(initials) on delete cascade on update cascade,
	foreign key(semester, section) references class(semester, section) on delete cascade on update cascade,
	foreign key(code) references subject(code) on delete cascade on update cascade,
